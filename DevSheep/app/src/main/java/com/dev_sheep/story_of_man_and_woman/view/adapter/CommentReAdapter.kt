...
class CommentReAdapter(private val commentList: List<Comment>,
                       private val context: Context,
                       private val feedViewModel: FeedViewModel,
                       private val onLastIndexListener: CommentReAdapter.OnLastIndexListener
) : RecyclerView.Adapter<CommentReAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        lateinit var my_m_seq : String
        private var sdf : SimpleDateFormat = SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
        fun bindView(item: Comment,feedViewModel:FeedViewModel,context: Context,onLastIndexListener: CommentReAdapter.OnLastIndexListener) {
...
//                this.isChecked = checked!!
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.adapter_re_comment, parent, false)
